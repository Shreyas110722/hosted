...
const ServiceList = styled.div`
  ...
  ${tw`flex flex-col justify-center items-start m-2 ml-0 space-y-2 mb-5  p-3 rounded border-opacity-40  hover:border-opacity-100 transition duration-500 ease-in-out cursor-pointer `};
  border-radius: 20px;
  @media (max-width: 768px) {
